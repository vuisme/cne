...
@section('title', __('API User Update'))


@section('content')
  {{ html()->modelForm($user, 'PATCH', route('admin.auth.api.user.update', $user->id))->class('form-horizontal')->open() }}
  <div class="card">
    <div class="card-body">
      <div class="row">
        <div class="col-sm-5">
          ...
          <div class="form-group row">
            ...
            <div class="col-md-10">
              <div class="input-group">
                <input type="text" name="api_token" class="form-control" value="{{old('api_token', $user->api_token)}}" id="api_token"
...
@push('after-scripts')
  ...
  <script>
     ...
     $(document).on('click', '#generate_key', function () {
        Swal.fire({
           title: 'Do you want to Generate new API token?',
