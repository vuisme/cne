...
{{ html()->form('POST', route('admin.coupon.store'))->open() }}
      ...
      <div class="card-body">
        ...
        <div class="form-group">
          <div class="checkbox d-flex align-items-center">
            {{ html()->label( html()->checkbox('active', true)
        ...
        <div class="form-group">
          ...
          <div class="form-check form-check-inline">
            <input type="radio" class="form-check-input" name="coupon_type" value="perchantage_discount"
              id="perchantage_discount" class="checking" @if($post_format==='perchantage_discount' ) checked @endif>
          ...
          <div class="form-check form-check-inline">
            <input type="radio" class="form-check-input" name="coupon_type" value="free_shipping" id="free_shipping"
              class="checking" @if($post_format==='free_shipping' ) checked @endif>
        ...
        <div class="form-group">
          ...
          <div class="input-group">
            {{html()->text('expiry_date', date('Y-m-d'))->class('form-control')->required(true)->attribute('aria-describedby','inputExpiryAppend')->placeholder('YYYY-MM-DD')->required(true)}}
            <div class="input-group-append">
