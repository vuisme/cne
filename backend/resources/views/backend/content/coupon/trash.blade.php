...
<div class="card">
  <div class="card-body">
    <div class="row">
      <div class="col-sm-5">
        <h3 class="card-title">Coupon Trashed</h3>
      </div> <!-- col-->
      <div class="col-sm-7 pull-right">
        <div class="btn-toolbar float-right" role="toolbar" aria-label="@lang('labels.general.toolbar_btn_groups')">
          <a href="{{ route('admin.coupon.index') }}" class="btn btn-success ml-1" data-toggle="tooltip"
            ...
            <tbody>
              ...
              <tr class="vertical-middle">
                ...
                <td class="text-center">
                  @include('backend.content.coupon.includes.actions-trash', ['coupon' => $coupon])
                </td>
              </tr>
              @endforeach
            </tbody>
    ...
    <div class="row">
      <div class="col-7">
        <div class="float-left">
          {!! $coupons->total() !!}
          {{ trans_choice('Coupon Trashed', $coupons->total()) }}
        </div>
      </div> <!-- col-->
      <div class="col-5">
