<div class="card mb-3">
  ...
  <div class="card-body">
    ...
    <div class="form-group">
      {{html()->label('Invoice Logo (512x512)')->for('invoice_logo')}}
    ...
    <div class="form-group">
      {{html()->label('Invoice Site Name')->for('invoice_site_name')}}
      {{html()->text('invoice_site_name', get_setting('invoice_site_name'))
      ->class('form-control')
      ->placeholder('Invoice Site Name')}}
    </div> <!-- form-group-->
