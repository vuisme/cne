  ...
  <div class="card-body">
    ...
    <fieldset>
      ...
      <div class="form-group">
        ...
        ->autofocus(true)}}
        <small id="partial_paid_help" class="form-text text-muted">
          Place of use 
    ...
    <fieldset>
      ...
      <div class="form-group">
        ...
        <small id="refunded_help" class="form-text text-muted">Use dynamic value for <span
            class="text-danger">[orderNumber]</span> and <span class="text-danger">[tracking]</span></small>
      </div> <!-- form-group-->
    </fieldset>
    <fieldset>
    ...
    <fieldset>
      ...
      <div class="form-group">
        ...
        ->autofocus(true)}}
        <small id="refunded_help" class="form-text text-muted">Use dynamic value for <span
            class="text-danger">[orderNumber]</span> and <span class="text-danger">[amount]</span></small>
      </div> <!-- form-group-->
    </fieldset>
    <fieldset>
