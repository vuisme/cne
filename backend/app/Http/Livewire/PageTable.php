...
class PageTable extends TableComponent
{
  ...
  {
    return Post::with('user')->where('post_type', 'page');
  }
  ...
  public function columns(): array
  {
    return [
      ...
      Column::make(__('Action'), 'action')
        ->format(function (Post $model) {
          return view('backend.content.page.includes.actions', ['page' => $model]);
        }),
    ];
  }
